...
Genera 3ted by 'django-admin startproject' using Django 3.0.
...
MIDDLEWARE = [
    ...
    'django.middleware.cache.UpdateCacheMiddleware',  # Cache middleware at the top
